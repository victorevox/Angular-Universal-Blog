...
const genDirNodeModules = path.join(process.cwd(), 'public/src', '$$_gendir', 'node_modules');
...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "public/src/styles.css"),
          path.join(process.cwd(), "node_modules/tinymce/skins/lightgray/content.min.css"),
          path.join(process.cwd(), "node_modules/tinymce/skins/lightgray/skin.min.css")
        ],
        "test": /\.css$/,
        "use": [
          {
